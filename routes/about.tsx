    ...
    <Layout title="About - The Questline">
      <div class="max-w-4xl mx-auto px-6 py-20">
        ...
        <div class="space-y-16">
          <section class="bg-background-light/30 backdrop-blur-sm p-10 rounded-xl border border-primary-dark/20">
            <h2 class="font-serif text-3xl text-white mb-6">Our Story</h2>
          ...
          <section class="bg-background-light/30 backdrop-blur-sm p-10 rounded-xl border border-primary-dark/20">
            <h2 class="font-serif text-3xl text-white mb-6">Our Mission</h2>
            <p class="text-white/90 leading-relaxed mb-6">
          ...
          <section class="bg-background-light/30 backdrop-blur-sm p-10 rounded-xl border border-primary-dark/20">
            <h2 class="font-serif text-3xl text-white mb-6">Our Approach</h2>
            <p class="text-white/90 leading-relaxed">
